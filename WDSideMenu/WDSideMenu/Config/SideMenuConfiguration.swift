...
let sizeMenuHeightConfig = Constants.SCREEN_HEIGHT * 0.7   //this is valid only for BottomMenu
let scaleFactorConfig:CGFloat = 0.2
let sideMenuRelativePositionConfig:SideMenuRelativePosition = .AboveMainView
